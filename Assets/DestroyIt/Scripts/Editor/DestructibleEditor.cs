        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Separator();
                ...
                if (destructible.useFallbackParticle)
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("", GUILayout.Width(15));
                    destructible.fallbackParticleScale = EditorGUILayout.Vector3Field(new GUIContent("Scale Override", "Here you can override the scale the particle effect when it spawns."), fallbackParticleScale.vector3Value);
                    EditorGUILayout.EndHorizontal();
                }
